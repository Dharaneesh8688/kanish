    ...
    <div class="table-responsive shadow-sm border rounded p-3 bg-white">
      <table class="table table-bordered table-hover table-striped">
        ...
        <tbody class="text-nowrap">
          <?php
          // **Query only customers created by the logged-in employee**
          $sql = "SELECT * FROM customers WHERE created_by = '".mysqli_real_escape_string($conn, $created_by)."' ORDER BY id DESC";
