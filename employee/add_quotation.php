...
foreach ($items as $item) {
   ...
   $created_by =  $_SESSION['employee_name'] ??'';
    ...
    $stmt->bind_param("ssssssssddsdddddss",
    $client_id,
    $client_name,
    $client_phone_id,
    $client_phone,
...
<div class="col-md-2">
  ...
  <textarea name="notes" class="form-control" rows="3" placeholder="Enter any additional notes here..."></textarea>
</div>
...
$('#particular_table tbody tr').each(function(i){
  ...
  items.push({
    ...
    hardware: cols.eq(11).text().trim() || 0, 
